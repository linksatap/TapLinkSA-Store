            ...
            >
              ...
              <div className="bg-gradient-to-br from-gold/10 to-yellow-100 rounded-2xl p-6 space-y-4 shadow-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-bold text-dark text-lg">شحن مجاني</p>
                  ...
                  >
                    <div>
                      ...
                      <ul className="space-y-2 text-gray-600">
                        <li>✓ شحن مجاني لجميع مناطق المملكة</li>
                        <li>✓ التوصيل خلال 1-3 أيام عمل</li>
                    ...
                    <div>
                      ...
                      <ul className="space-y-2 text-gray-600">
                        ...
                        <li>✓ الإرجاع مجاني لجميع المناطق</li>
                      </ul>
                    </div>
                  </motion.div>
                )}
